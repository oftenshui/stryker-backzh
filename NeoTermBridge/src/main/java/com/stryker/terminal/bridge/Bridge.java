...
public class Bridge {
  ...
  private static final String NEOTERM_PACKAGE = "com.stryker.terminal";
  private static final String NEOTERM_REMOTE_INTERFACE = "com.stryker.terminal.ui.term.NeoTermRemoteInterface";
